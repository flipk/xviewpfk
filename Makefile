...
# operating system:  FreeBSD 3.2-RELEASE i386 [ELF] (3.2.0)
...
install.man:: docs/xv.man
	@if [ -d $(DESTDIR)$(MANDIR) ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(DESTDIR)$(MANDIR)); fi
	$(RM) $(DESTDIR)$(MANDIR)/xv.$(MANSUFFIX)*
	$(INSTALL) -c $(INSTMANFLAGS) docs/xv.man \
	$(DESTDIR)$(MANDIR)/xv.$(MANSUFFIX)
	-$(COMPRESSMANCMD) $(DESTDIR)$(MANDIR)/xv.$(MANSUFFIX)

install.man:: docs/bggen.man
	@if [ -d $(DESTDIR)$(MANDIR) ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(DESTDIR)$(MANDIR)); fi
	$(RM) $(DESTDIR)$(MANDIR)/bggen.$(MANSUFFIX)*
	$(INSTALL) -c $(INSTMANFLAGS) docs/bggen.man \
	$(DESTDIR)$(MANDIR)/bggen.$(MANSUFFIX)
	-$(COMPRESSMANCMD) $(DESTDIR)$(MANDIR)/bggen.$(MANSUFFIX)

install.man:: docs/xcmap.man
	@if [ -d $(DESTDIR)$(MANDIR) ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(DESTDIR)$(MANDIR)); fi
	$(RM) $(DESTDIR)$(MANDIR)/xcmap.$(MANSUFFIX)*
	$(INSTALL) -c $(INSTMANFLAGS) docs/xcmap.man \
	$(DESTDIR)$(MANDIR)/xcmap.$(MANSUFFIX)
	-$(COMPRESSMANCMD) $(DESTDIR)$(MANDIR)/xcmap.$(MANSUFFIX)

install.man:: docs/xvp2p.man
	@if [ -d $(DESTDIR)$(MANDIR) ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(DESTDIR)$(MANDIR)); fi
	$(RM) $(DESTDIR)$(MANDIR)/xvpictoppm.$(MANSUFFIX)*
	$(INSTALL) -c $(INSTMANFLAGS) docs/xvp2p.man \
	$(DESTDIR)$(MANDIR)/xvpictoppm.$(MANSUFFIX)
	-$(COMPRESSMANCMD) $(DESTDIR)$(MANDIR)/xvpictoppm.$(MANSUFFIX)
